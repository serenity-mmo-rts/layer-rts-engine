...
(function (exports) {
     ...
     * @constructor
     */
    var Tower = function (parent, type) {
     ...
     */
    Tower.prototype = Object.create(AbstractBlock.prototype);
    var proto = Tower.prototype;
    proto.constructor = Tower;
     ...
     */
    Tower.prototype.finalizeBlockClass('Tower');
    exports.Tower = Tower
