...
(function (exports) {
     ...
     * @constructor
     */
    var Environment = function (parent, type) {
     ...
     */
    Environment.prototype = Object.create(AbstractBlock.prototype);
    var proto = Environment.prototype;
    proto.constructor = Environment;
     ...
     */
    Environment.prototype.finalizeBlockClass('Environment');
