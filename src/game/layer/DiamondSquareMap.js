...
var DiamondSquareMap = function(iteration,xPos,yPos,width,height,n,lowResMap) {
...
PlanetGenerator.prototype.crop = function(cropRegion) {
    var sizeX = this.sizeX;
    var sizeY = this.sizeY;
...
DiamondSquareMap.prototype.dispArray = function() {
    for (var y =0; y < this.map.length/this.sizeX; y ++) {
        var output = '';
        for (var x = 0; x < this.sizeX; x ++) {
            output += this.map[ y*this.sizeX + x] + ' ';
        }
        console.log(output);
    }
};
